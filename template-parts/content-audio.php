<?php
/**
 * Template part for displaying audio posts formats.
 *
...
?>
<div class="single-blog audio-post">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post-details">
				...
				<header class="entry-header">
					<h2 class="entry-title"><a href="<?php the_permalink();?>"><?php echo the_title();?></a>
					</h2>

			   </header><!-- .entry-header -->

				<div class="audio-excerpt audio-embed-container">
					<?php the_content();?>	
				</div>
